...
export default function App() {
  ...
  const handleSubmit = (evt) => {
    ...
    var url = 'https://api.hsforms.com/submissions/v3/integration/submit/5737142/68294689-f420-425e-9ef9-2a41f226fad5'
    var data = {
      "fields": [
        {
          "name": "email",
        ...
        ,
        {
          "name": "LEGAL_CONSENT.subscription_type_7285045",
          "value": true
        }
      ],
      "context": {
...
//           <h1 className="font-default text-lpBlack-main leading-tight text-center text-3xl sm:text-4xl lg:text-5xl">Raise your company’s digital <span className="text-lpGreen-main">intelligence</span>. Mobilize MarTech <span className="text-lpGreen-main">solutions</span> towards the greatest business impact.</h1>
...
//             <h1 className="font-default text-lpBlack-main leading-tight text-4xl">What we <span className="text-lpGreen-main">do</span></h1>
//             <div className={"flex h-10 w-full"}></div>
...
//       <div className={"container flex mx-auto px-6 flex-col md:px-20 lg:px-20 xl:px-20 2xl:px-28"}>
//         <div className={"flex h-20 lg:h-40 w-full"}></div>
//         <h1 className="font-default text-lpBlack-main leading-tight text-center text-3xl sm:text-4xl lg:text-5xl">Marketing Automation <span className="text-lpGreen-main">Success</span> Cases</h1>
//         <div className={"flex h-16 w-full"}></div>
...
//         <HubspotForm
//           portalId='5737142'
//           formId='e428abb1-4e95-43da-8f47-69429d77114c'
...
//           <h1 className="font-default text-white leading-tight text-center text-3xl sm:text-4xl lg:text-5xl">Meet our <span className="text-lpGreen-main">Customers</span></h1>
//           <div className={"flex h-16 w-full"}></div>
